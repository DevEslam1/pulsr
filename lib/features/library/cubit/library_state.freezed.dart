...
mixin _$LibraryState {
 ...
 List<SongsTableData> get songs; List<AlbumsTableData> get albums; List<ArtistsTableData> get artists; List<GenreItem> get genres; List<YearItem> get years; List<SongsTableData> get favorites; List<FolderItem> get folders; String get sortBy; bool get ascending; bool get isLoading; String? get errorMessage; Set<int> get selectedSongIds; bool get isMultiSelectMode; LibraryViewMode get viewMode;
...
@useResult
$Res call({
 List<SongsTableData> songs, List<AlbumsTableData> albums, List<ArtistsTableData> artists, List<GenreItem> genres, List<YearItem> years, List<SongsTableData> favorites, List<FolderItem> folders, String sortBy, bool ascending, bool isLoading, String? errorMessage, Set<int> selectedSongIds, bool isMultiSelectMode, LibraryViewMode viewMode
});
...
as List<ArtistsTableData>,genres: null == genres ? _self.genres : genres // ignore: cast_nullable_to_non_nullable
as List<GenreItem>,years: null == years ? _self.years : years // ignore: cast_nullable_to_non_nullable
as List<YearItem>,favorites: null == favorites ? _self.favorites : favorites // ignore: cast_nullable_to_non_nullable
as List<SongsTableData>,folders: null == folders ? _self.folders : folders // ignore: cast_nullable_to_non_nullable
as List<FolderItem>,sortBy: null == sortBy ? _self.sortBy : sortBy // ignore: cast_nullable_to_non_nullable
...
as String?,selectedSongIds: null == selectedSongIds ? _self.selectedSongIds : selectedSongIds // ignore: cast_nullable_to_non_nullable
as Set<int>,isMultiSelectMode: null == isMultiSelectMode ? _self.isMultiSelectMode : isMultiSelectMode // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<SongsTableData> songs,  List<AlbumsTableData> albums,  List<ArtistsTableData> artists,  List<GenreItem> genres,  List<YearItem> years,  List<SongsTableData> favorites,  List<FolderItem> folders,  String sortBy,  bool ascending,  bool isLoading,  String? errorMessage,  Set<int> selectedSongIds,  bool isMultiSelectMode,  LibraryViewMode viewMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryState() when $default != null:
return $default(_that.songs,_that.albums,_that.artists,_that.genres,_that.years,_that.favorites,_that.folders,_that.sortBy,_that.ascending,_that.isLoading,_that.errorMessage,_that.selectedSongIds,_that.isMultiSelectMode,_that.viewMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<SongsTableData> songs,  List<AlbumsTableData> albums,  List<ArtistsTableData> artists,  List<GenreItem> genres,  List<YearItem> years,  List<SongsTableData> favorites,  List<FolderItem> folders,  String sortBy,  bool ascending,  bool isLoading,  String? errorMessage,  Set<int> selectedSongIds,  bool isMultiSelectMode,  LibraryViewMode viewMode)  $default,) {final _that = this;
switch (_that) {
case _LibraryState():
return $default(_that.songs,_that.albums,_that.artists,_that.genres,_that.years,_that.favorites,_that.folders,_that.sortBy,_that.ascending,_that.isLoading,_that.errorMessage,_that.selectedSongIds,_that.isMultiSelectMode,_that.viewMode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<SongsTableData> songs,  List<AlbumsTableData> albums,  List<ArtistsTableData> artists,  List<GenreItem> genres,  List<YearItem> years,  List<SongsTableData> favorites,  List<FolderItem> folders,  String sortBy,  bool ascending,  bool isLoading,  String? errorMessage,  Set<int> selectedSongIds,  bool isMultiSelectMode,  LibraryViewMode viewMode)?  $default,) {final _that = this;
switch (_that) {
case _LibraryState() when $default != null:
return $default(_that.songs,_that.albums,_that.artists,_that.genres,_that.years,_that.favorites,_that.folders,_that.sortBy,_that.ascending,_that.isLoading,_that.errorMessage,_that.selectedSongIds,_that.isMultiSelectMode,_that.viewMode);case _:
  return null;
...
@override@JsonKey() List<SongsTableData> get songs {
...
@override@JsonKey() List<AlbumsTableData> get albums {
...
@override@JsonKey() List<ArtistsTableData> get artists {
...
@override@JsonKey() List<GenreItem> get genres {
...
@override@JsonKey() List<YearItem> get years {
...
@override@JsonKey() List<SongsTableData> get favorites {
...
@override@JsonKey() List<FolderItem> get folders {
...
@override@JsonKey() Set<int> get selectedSongIds {
...
/// Create a copy of LibraryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? songs = null,Object? albums = null,Object? artists = null,Object? genres = null,Object? years = null,Object? favorites = null,Object? folders = null,Object? sortBy = null,Object? ascending = null,Object? isLoading = null,Object? errorMessage = freezed,Object? selectedSongIds = null,Object? isMultiSelectMode = null,Object? viewMode = null,}) {
  return _then(_LibraryState(
songs: null == songs ? _self._songs : songs // ignore: cast_nullable_to_non_nullable
as List<SongsTableData>,albums: null == albums ? _self._albums : albums // ignore: cast_nullable_to_non_nullable
as List<AlbumsTableData>,artists: null == artists ? _self._artists : artists // ignore: cast_nullable_to_non_nullable
as List<ArtistsTableData>,genres: null == genres ? _self._genres : genres // ignore: cast_nullable_to_non_nullable
as List<GenreItem>,years: null == years ? _self._years : years // ignore: cast_nullable_to_non_nullable
as List<YearItem>,favorites: null == favorites ? _self._favorites : favorites // ignore: cast_nullable_to_non_nullable
as List<SongsTableData>,folders: null == folders ? _self._folders : folders // ignore: cast_nullable_to_non_nullable
as List<FolderItem>,sortBy: null == sortBy ? _self.sortBy : sortBy // ignore: cast_nullable_to_non_nullable
as String,ascending: null == ascending ? _self.ascending : ascending // ignore: cast_nullable_to_non_nullable
as bool,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,selectedSongIds: null == selectedSongIds ? _self._selectedSongIds : selectedSongIds // ignore: cast_nullable_to_non_nullable
as Set<int>,isMultiSelectMode: null == isMultiSelectMode ? _self.isMultiSelectMode : isMultiSelectMode // ignore: cast_nullable_to_non_nullable
as bool,viewMode: null == viewMode ? _self.viewMode : viewMode // ignore: cast_nullable_to_non_nullable
as LibraryViewMode,
  ));
