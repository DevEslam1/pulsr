...
import '../../genre_detail/presentation/genre_detail_screen.dart';
import '../../year_detail/presentation/year_detail_screen.dart';
...
class _LibraryScreenState extends State<LibraryScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildEmptyState(
    ...
    IconData icon = Icons.music_off_rounded,
    Color? iconColor,
  }) {
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Container(
            ...
            child: const Icon(Icons.style_rounded, color: AppColors.primary, size: 24),
          ),
          title: Text(
            genre.name,
            style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15),
          ...
          subtitle: Text(
            Formatters.formatTrackCount(genre.songCount),
            style: const TextStyle(color: AppColors.textSecondary, fontSize: 12),
          ),
          trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.textSecondary),
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => GenreDetailScreen(genreItem: genre)),
            );
          },
        );
      },
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          subtitle: Text(
            Formatters.formatTrackCount(yearItem.songCount),
            style: const TextStyle(color: AppColors.textSecondary, fontSize: 12),
          ),
          trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.textSecondary),
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => YearDetailScreen(yearItem: yearItem)),
            );
          },
        );
      },
