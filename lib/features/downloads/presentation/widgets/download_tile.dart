...
// DL-20: Granular BlocSelector to prevent list rebuild storms during progress ticks.
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<DownloadsCubit, DownloadsState, DownloadTask?>(
      ...
      builder: (context, currentTask) {
        ...
        final (statusIcon, statusColor, statusLabel) = switch (t.status) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            t.title.isNotEmpty ? t.title : t.videoId,
                            maxLines: 1,
                    ...
                    Semantics(
                      ...
                      child: PopupMenuButton<String>(
                        ...
                        onSelected: (action) {
                          ...
                          switch (action) {
                            case 'pause':
                              cubit.pauseDownload(t.videoId);
                              break;
                            case 'resume':
                              cubit.resumeDownload(t.videoId);
                              break;
                            case 'retry':
                              cubit.retryDownload(t.videoId);
                              break;
                            case 'prioritize':
                              cubit.prioritizeDownload(t.videoId);
                              break;
                            case 'delete':
                              cubit.deleteDownload(t.videoId);
                              break;
                          }
                        },
                        itemBuilder: (context) => [
