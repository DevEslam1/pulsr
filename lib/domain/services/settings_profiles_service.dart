...
class SettingsProfile {
  ...
  const SettingsProfile({
    ...
    this.crossfeedEnabled,
    this.crossfeedDelayUs,
    this.crossfeedFeedDb,
  });
  ...
  factory SettingsProfile.fromJson(Map<String, dynamic> json) =>
      SettingsProfile(
        ...
        headphoneProfileId: json['headphoneProfileId'] as String?,
        crossfeedEnabled: json['crossfeedEnabled'] as bool?,
        crossfeedDelayUs: (json['crossfeedDelayUs'] as num?)?.toDouble(),
        crossfeedFeedDb: (json['crossfeedFeedDb'] as num?)?.toDouble(),
      );
