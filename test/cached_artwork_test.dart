...
void main() {
  group('CachedArtwork Widget Tests', () {
    testWidgets('Renders placeholder when no cached bytes available', (tester) async {
    ...
    testWidgets('Renders Image.memory when cached bytes present', (tester) async {
      final customCache = ArtworkLruCache.withCapacity(10);

      // Create 1x1 transparent PNG bytes
      final samplePng = Uint8List.fromList([
        137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0,
        1, 0, 0, 0, 1, 8, 6, 0, 0, 0, 31, 213, 196, 200, 0, 0, 0, 13, 73, 68,
        65, 84, 120, 156, 99, 96, 248, 15, 0, 1, 5, 1, 2, 162, 162, 190, 253,
