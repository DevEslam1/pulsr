...
void main() {
  ...
  group('MediaScannerService Unit Tests', () {
    test(
        'isSystemIgnoredPath detects WhatsApp, Telegram, call recordings and dot folders',
        () {
      expect(
          MediaScannerService.isSystemIgnoredPath(
              '/storage/emulated/0/WhatsApp/Media/WhatsApp Voice Notes/1.opus'),
          isTrue);
      expect(
          MediaScannerService.isSystemIgnoredPath(
              '/storage/emulated/0/Android/media/com.whatsapp/audio.mp3'),
          isTrue);
      expect(
          MediaScannerService.isSystemIgnoredPath(
      ...
      expect(
          MediaScannerService.isSystemIgnoredPath(
              '/storage/emulated/0/Recordings/call_123.m4a'),
          isTrue);
      expect(
          MediaScannerService.isSystemIgnoredPath(
              '/storage/emulated/0/Music/.thumbnails/art.jpg'),
          isTrue);
      expect(
          MediaScannerService.isSystemIgnoredPath(
